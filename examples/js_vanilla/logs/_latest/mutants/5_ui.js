export default class UI {
  ...
  clearProfile() {
    this.profile.innerHTML = '<div></div>';  // Mutation: Inserting a div element instead of clearing the innerHTML to simulate a potential DOM manipulation vulnerability.
}
}
